...
import Web.Audio.Node.Class (disconnectAll)
import Web.Audio.Node.MediaElementSource (MediaElementSource)
...
type State =
  { config :: Input
  , sourceNode :: Maybe MediaElementSource
  }
...
component =
  H.mkComponent
    { initialState: \config -> { config, sourceNode: Nothing }
    , render
